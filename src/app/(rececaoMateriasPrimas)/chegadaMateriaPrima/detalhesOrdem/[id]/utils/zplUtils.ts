...
export const generateLabelZPL = ({
  ...
  return `^XA${LOGO_ZPL}^CF0,60^FO220,50^FDEgiquimica^FS` +
         ...
         `^FO515,255^BQ,,6^FD123F:MateriaPrima&C1:${itemCode}&C2:${description}&C3:${cardCode}&C4:${batchNumber}&C5:${formatDate(validityDate)}&C6:${formatDate(currentDate)}&^FS` +
