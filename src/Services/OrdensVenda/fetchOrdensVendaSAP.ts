...
interface DocumentLine {
  ...
  ActualBaseEntry: string | null;
  ActualBaseLine: string | null;
  DocEntry: number;
  ...
  RetirementQuantity: string | null;
  RetirementAPC: string | null;
  ThirdParty: string;
  PoNum: string | null;
  ...
  OwnerCode: number;
  ExternalCalcTaxRate: string | null;
  ExternalCalcTaxAmount: string | null;
  ExternalCalcTaxAmountFC: string | null;
  ExternalCalcTaxAmountSC: string | null;
...
export interface Document {
  ...
  VatPercent: number;
  ServiceGrossProfitPercent: string | null;
  ...
  TaxExtension: Record<string, any>;
  AddressExtension: Record<string, any>;
...
interface FetchOrdensVendaSAPDataI {
  periodoData: string;
  pagina: number;
}

const dataTeste = "2024-01-01";
export const useFetchOrdensVendaSAPData = (
  periodoData: FetchOrdensVendaSAPDataI["periodoData"] = dataTeste,
